...
2. Repository name: `mimoai` (or your preferred name)
...
git remote add origin https://github.com/YOUR_USERNAME/mimoai.git
git branch -M main
...
```bash
gh auth login
gh repo create mimoai --public --source=. --remote=origin --push
```
